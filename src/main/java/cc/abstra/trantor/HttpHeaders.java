...
public final class HttpHeaders {
     ...
     */
    public static final List<String> hopByHopHeadersLc;
    static {
        hopByHopHeadersLc = new ArrayList<String>() {{
         add(CONNECTION.toLowerCase());
         add(KEEP_ALIVE.toLowerCase());
         add(PROXY_AUTHENTICATE.toLowerCase());
         add(PROXY_AUTHORIZATION.toLowerCase());
         add(TE.toLowerCase());
         add(TRAILER.toLowerCase());
         add(TRANSFER_ENCODING.toLowerCase());
         add(UPGRADE.toLowerCase());
        }};
    }

    public static final List<String> integerValuedHeadersLc;
    static {
        integerValuedHeadersLc = new ArrayList<String>() {{
            add(CONTENT_LENGTH.toLowerCase());
            add(MAX_FORWARDS.toLowerCase());
            add(AGE.toLowerCase());
